      ...
      <main id="main-content">
        <section aria-labelledby="install-heading" className="pt-10 pb-16 sm:pt-16 sm:pb-24">
          <div className="mx-auto w-full max-w-4xl px-4 text-center sm:px-6">
            ...
            <h1 id="install-heading" className="mt-4 text-[2rem] font-medium leading-[1.08] tracking-[-0.04em] text-[var(--text-primary)] sm:text-[3rem]">
              Download Synara
            </h1>
            <p className="mx-auto mt-5 max-w-xl text-[14px] leading-[1.7] text-[var(--text-secondary)] sm:text-[16px]">
              Install the desktop app, connect a coding-agent runtime already
              authenticated on your machine, and start with one repository and
              one bounded task.
            </p>
